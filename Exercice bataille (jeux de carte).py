...
# boucle de jeu (si un joueur n'a plus de carte il perd la partie sinon continue en boucle)
while j1 or j2:
    if not j1:
        print ("kaiba perd alors qu'il a 3 dragons blanc aux yeux bleu O_O' ")
        break
    if not j2:
